...
<div class="ctr">
			<h2>sRMCHAT</h2>
                        <p>sRMCHAT helps you connect and share with the people in your life</p>
</div>
<div class="signup-form">
    <form action="" method="post">
        ...
        <div class="form-group">
        	...
        	<input type="text" class="form-control" placeholder="Example: harsh" name="user_name" autocomplete="off" required="required">
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
			<label>Email</label>
        	<input type="email" class="form-control" placeholder="rockstarharsh@gmail.com" name="user_email" autocomplete="off" required="required">
        </div>
        <div class="form-group">
			<label>Country</label>
